<div x-data="{ show: false, message: '', type: 'success', timeoutId: null }" x-show="show"
    x-on:notify.window="
        (() => {
            ...
            timeoutId = setTimeout(() => { show = false }, 5000);
        })()
    "
    ...
    <div class="flex items-center">
        <svg x-show="type === 'success'" class="size-5 mr-3 text-white fill-white" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256">
        ...
        <svg x-show="type === 'error'" class="size-5 mr-3 text-white fill-white" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256">
            <rect width="256" height="256" fill="none" />
        ...
        <svg x-show="type === 'warning'" class="size-5 mr-3 text-white fill-white" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256">
            <rect width="256" height="256" fill="none" />
            <path
        ...
        <svg x-show="type === 'info'" class="size-5 mr-3 text-white fill-white" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 256 256">
            <rect width="256" height="256" fill="none" />
            <circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round"
                stroke-linejoin="round" stroke-width="16" />
