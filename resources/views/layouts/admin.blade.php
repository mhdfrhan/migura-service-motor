            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <a wire:navigate href="{{ route('admin.payments.index') }}"
                    ...
                    @if (isset($pendingPayments) && $pendingPayments > 0)
                        <span
                            class="ml-auto bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full">{{ $pendingPayments }}</span>
                    @endif
                </a>
                ...
                <div class="pt-4 mt-4 border-t border-gray-200">
                    ...
                    <a wire:navigate href="{{ route('admin.activity-logs.index') }}"
                        class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all {{ request()->routeIs('admin.activity-logs.*') ? 'bg-gradient-to-r from-sky-500 to-blue-600 text-white shadow-lg shadow-sky-500/30' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
