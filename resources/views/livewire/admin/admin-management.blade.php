<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Kelola data administrator sistem</p>
        </div>
                    ...
                    @forelse ($admins as $admin)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center text-white font-bold">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <p class="text-sm text-gray-900">{{ $admin->created_at->format('d M Y') }}</p>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-500">
                                    ...
                                    <p class="text-lg font-semibold">Tidak ada admin</p>
                                    <p class="text-sm mt-1">Belum ada administrator yang terdaftar</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <!-- Modal Form -->
    <x-modal name="admin-form-modal" maxWidth="2xl" focusable>
        <div class="p-6">
            <h2 class="text-lg font-medium text-gray-900 mb-6">
                {{ $userId ? 'Edit Admin' : 'Tambah Admin' }}
            </h2>

            <form wire:submit.prevent="saveAdmin" class="space-y-6">
                <!-- Name -->
                <div>
                ...
                <div class="flex items-center justify-end gap-3">
                    <x-secondary-button type="button" @click="$dispatch('close-modal', 'admin-form-modal')">
                        Batal
                    </x-secondary-button>
                    <x-primary-button type="submit">
                        {{ $userId ? 'Simpan Perubahan' : 'Tambah Admin' }}
                    </x-primary-button>
                </div>
            </form>
        </div>
